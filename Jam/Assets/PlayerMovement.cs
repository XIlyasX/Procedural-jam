...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Quaternion localRotation = Quaternion.Euler(-mouseYSmooth, -rotationZTmp * rotationSpeed, mouseXSmooth);
        lookRotation = lookRotation * localRotation;
        transform.rotation = lookRotation;
        rotationZ -= mouseXSmooth;
        spaceshipRoot.transform.localEulerAngles = new Vector3(defaultShipRotation.x, -rotationZ, 0);
